...
test('service CTAs route the consultation to booking and scoped work to the contact form', () => {
...
test('contact form defaults to the assessment sprint while preserving explicit service selection', () => {
  assert.match(
    contactForm,
