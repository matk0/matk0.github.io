...
<div class="cv-header">
  <h1>Ing. Matej Lukášik</h1>
  <p>Trnava, Slovakia | +421 944 302 185 | matej@matejlukasik.com</p>
</div>
...
### CTO — Zeilenwerk GmbH
*08/2017 – 12/2022 | Remote, Switzerland*

First employee and CTO. Took a small startup and helped turn it into a structured, well-running organization.

- **Grew the development team from 2 to 10 within 3 years.**
- Established development processes — Agile workflows, QA practices, team collaboration — using tools like JIRA.
- Introduced React, React Native, and GraphQL into the company's stack.
- Led medium to large-scale projects **from inception to completion.**

### Full stack developer — datamolino s.r.o.
*11/2016 – 07/2017 | Remote, Slovakia*
- Redesigned the main dashboard to present data from both internal and external sources. **Shaped the information architecture and UX beyond just coding**. The overhaul put us ahead of our main competitor, Receipt Bank.
- Built the QuickBooks Online integration, opening access to the QBO app marketplace and creating significant new business opportunities.

### Full stack developer — Primehammer s.r.o.
*07/2014 – 11/2016 | Remote, Czech Republic*

- Vive.co: Led a front-end redesign using Sass and React, turning the booking process into a single-page application that was faster and easier to use.
- Hlidacky.cz: Designed and built API access for mobile apps, documented with Swagger. Introduced declarative authorization for the admin interface.
